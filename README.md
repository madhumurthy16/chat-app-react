>Slack inspired real-time chat application, that allows users to create new chat rooms and send/receive messages. Built the project ground up using ReactJS, JSX, Firebase and responsive styling was done using css3 flexbox.
